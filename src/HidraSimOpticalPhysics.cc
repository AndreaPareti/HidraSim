//**************************************************
// \file HidraSimOpticalPhysics.cc 
// \brief: Implementation of HidraSimOpticalPhysics class
...
void HidraSimOpticalPhysics::ConstructParticle() {
    
    G4OpticalPhoton::OpticalPhotonDefinition();

}

void HidraSimOpticalPhysics::ConstructProcess() {
    
    G4cout<<"HidraSimOpticalPhysics:: Add Optical Physics Processes"<<G4endl;
