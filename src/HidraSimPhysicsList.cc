...
//Define constructor
//
HidraSimPhysicsList::HidraSimPhysicsList(G4String physName, const G4bool FullOptic )
    ...
    for (G4int i = 0; ; ++i) {
        ...
        G4cout << "HidraSim->RegisterPhysics: " << elem->GetPhysicsName() << G4endl;
    ...
    // 
    AbsorptionOn = true;
    RegisterPhysics( OpPhysics = new HidraSimOpticalPhysics(fFullOptic, AbsorptionOn) );
    
}

//Define de-constructor
//
HidraSimPhysicsList::~HidraSimPhysicsList(){}
